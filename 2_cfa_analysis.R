...
tenth_cfa <- "
  social self = ~ cr_mva_opinfriend_REV + 
                    cr_mva_se_solve + 
                    cr_mva_se_means + 
                    cr_mva_se_goal + 
                    cr_mva_se_event + 
...
model_a_cfa <- "socialself = ~ cr_hn_scale + 
             ...
             socialworld = ~ cr_si_diversity + 
                              cr_si_peopletrusted + 
                              cr_si_peoplehelp + 
                              cr_si_threaten + 
                              cr_si_othersthreaten + 
                              cr_si_trust_family + 
                              cr_si_trust_neighbor +
                              cr_si_trust_know + 
                              cr_si_trust_first + 
                              cr_si_trust_diffrelig + 
            ...
            nonsocialsafetythreat = ~ 
                              ...
                              cr_edu_abusetell +
                              cr_vio_safe_home +
                              cr_vio_safe_travelwork + 
                              cr_vio_safe_market +
                              cr_vio_safe_travelmarket + 
                              cr_vio_safe_waterfuel +
                              cr_vio_safe_religious + 
                              cr_vio_safe_makani + 
                              cr_edu_trvlsafe + 
                              cr_edu_schsafe
                              "

model_a_cfa_fit <- cfa(model_a_cfa, 
                       data = reduced_df, 
                       ordered = T, 
                       estimator = "WLSMV",
                       missing = "pairwise")

# model_b_cfa_fit <- cfa(model_a_cfa, 
#                        data = reduced_df, 
#                        ordered = T, 
#                        estimator = "WLSMV",
#                        missing = "pairwise")
...
lavInspect(model_a_cfa_fit, what="std")$lambda
